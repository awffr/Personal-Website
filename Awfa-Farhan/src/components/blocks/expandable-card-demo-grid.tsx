...
const cards = [
  {
    ...
    content: () => (
      <p>
        I am fascinated by disruptive technologies and how they tackle complex
        challenges using advanced algorithms and computational paradigms.
        Innovations like AI, quantum computing, and blockchain drive my
        enthusiasm for transformative solutions.
      </p>
    ),
  },
  {
    ...
    content: () => (
      <p>
        Cloud computing enables scalable, on-demand resources, optimizing
        agility and cost-efficiency. My experience with AWS and Azure
        showcases how dynamic provisioning and containerization streamline
  ...
  {
    description:
      "Actionable insights through data mining, end-to-end analytics, and visualization.",
    title: "Data Analytics",
    src: "/interest-image-data.webp",
    content: () => (
      <p>
        Data analytics involves using big data frameworks and statistical
        models to derive insights. Tools like R and Python for data mining and
        predictive analytics help transform raw data into actionable
        strategies.
      </p>
    ),
  },
  {
    ...
    content: () => (
      <p>
        Machine learning leverages neural networks for autonomous learning and
        optimization. My work with deep learning and reinforcement learning
        enhances predictive analytics and process automation.
      </p>
    ),
  },
];
